...
public class YishengCollectionController {
    ...
    private static final String TABLE_NAME = "yishengCollection";
...
, "yishengId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
    ...
    */
    ...
    public R save(@RequestBody YishengCollectionEntity yishengCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            yishengCollection.setYishengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R update(@RequestBody YishengCollectionEntity yishengCollection, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,yishengCollection:{}",this.getClass().getName(),yishengCollection.toString());
        YishengCollectionEntity oldYishengCollectionEntity = yishengCollectionService.selectById(yishengCollection.getId());//查询原先数据
...
//            yishengCollection.setYishengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<YishengCollectionEntity> oldYishengCollectionList =yishengCollectionService.selectBatchIds(Arrays.asList(ids));//要删除的数据
    ...
    */
    ...
    public R add(@RequestBody YishengCollectionEntity yishengCollection, HttpServletRequest request){
        ...
        Wrapper<YishengCollectionEntity> queryWrapper = new EntityWrapper<YishengCollectionEntity>()
            ...
            .eq("yonghu_id", yishengCollection.getYonghuId())
            .eq("yisheng_collection_types", yishengCollection.getYishengCollectionTypes())
//            .notIn("yisheng_collection_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        YishengCollectionEntity yishengCollectionEntity = yishengCollectionService.selectOne(queryWrapper);
        if(yishengCollectionEntity==null){

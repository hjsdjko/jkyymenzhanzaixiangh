...
public class YishengCommentbackView extends YishengCommentbackEntity implements Serializable {
	...
	public YishengCommentbackView() {

	}

	public YishengCommentbackView(YishengCommentbackEntity yishengCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, yishengCommentbackEntity);
